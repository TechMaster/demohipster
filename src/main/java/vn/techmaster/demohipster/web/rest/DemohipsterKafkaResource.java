...
@RestController
@RequestMapping("/api/demohipster-kafka")
public class DemohipsterKafkaResource {

    private final Logger log = LoggerFactory.getLogger(DemohipsterKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public DemohipsterKafkaResource(KafkaProperties kafkaProperties) {
